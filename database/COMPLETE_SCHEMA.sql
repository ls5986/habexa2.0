-- ============================================
-- HABEXA COMPLETE DATABASE SCHEMA
-- ============================================
-- This script will:
...
DROP POLICY IF EXISTS "Users can view own amazon creds" ON public.amazon_credentials CASCADE;
...
-- Eligibility Cache
CREATE TABLE public.eligibility_cache (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    user_id UUID REFERENCES public.profiles(id) ON DELETE CASCADE NOT NULL,
    asin TEXT NOT NULL,
    seller_id TEXT,
...
CREATE TABLE public.telegram_deals (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    user_id UUID REFERENCES public.profiles(id) ON DELETE CASCADE NOT NULL,
...
-- Keepa Product Cache
CREATE TABLE public.keepa_cache (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    asin TEXT NOT NULL,
    marketplace_id TEXT DEFAULT 'ATVPDKIKX0DER',
...
CREATE TABLE public.keepa_usage (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
